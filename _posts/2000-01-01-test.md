...
In this article, I compare numbers of users in the Python and R communities.  I also compare statistics on the two women's meetup organizations for each language:  R-Ladies and PyLadies.  
