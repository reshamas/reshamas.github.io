...
[Scikit-learn](https://scikit-learn.org/stable/) is the machine learning library of Python.  Yet, there is only 1 woman in the [100 top contributors](https://scikit-learn.org/stable/about.html#citing-scikit-learn).
...
R:  <p   style="color:purple; font:italic"><b> 9.3% </b></p>
<p>
</p>
Python : <p style="color:purple; font:italic"><b> **2.0%**</b></p>
