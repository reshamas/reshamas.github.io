...
| Popular Technology Survey (SO*) | 6.1% |   | 38.8%                     |
| Language          | R            |        | Python                     |
| Sponsors          | R Consortium | none   | Python Software Foundation |   
| Field of Study    | Statistics   |        | Computer Science, others   |
| Board             | yes          | yes    | no                         |
...
| Official Conference Affiliation | ? | none | PyCon                     |
| Other Conferences | Rstudio::conf / useR! / NY R | none | PyData ?     |
| Language First Released | 1993 |  | 1990 |
* Note:  SO = Stack Overflow
