...
In this article, I compare numbers of users in the R and Python communities.  I also compare statistics on the respetive women's meetup organizations for each language:  R-Ladies and PyLadies.  
...
### Foundational
Many R users have a background in statistics.  Membership in the American Statistical Association (ASA) is 53% women, self-identified by survey respondents.  We can make a rough comparison to computer scientists.  The Association for Computing Machinery is the largest society of computer scientists.  Data is not yet available for the percent women members.  
